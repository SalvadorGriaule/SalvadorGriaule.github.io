...
const { titre , desktopSrc, phoneSrc, description, techUse}:{ titre : string, desktopSrc:string, phoneSrc:string, description:string, techUse:string[] } = $props()
...
>
    ...
    <div class="mt-3 flex flex-col lg:flex-row">
        ...
        <div class="p-2 lg:w-2/5 lg:border-l-2 border-black">
            ...
            <div class="flex justify-center flex-wrap space-x-2 space-y-2 lg:justify-start">
