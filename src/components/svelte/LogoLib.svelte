<script lang="ts">
  ...
  class Logo {
    ...
    svg: string;
    shadowColor: string;
    constructor(name: string, link: string, svg: string, shadowColor: string) {
      this.name = name;
      this.link = link;
      this.svg = svg;
  ...
  const logo: Logo[] = [
    ...
    new Logo("ts", "https://www.typescriptlang.org/", tsLogo.src, "#3178c6"),
    ...
    new Logo("node", "https://nodejs.org/fr", nodeLogo.src, "#75ac64"),
  ];
